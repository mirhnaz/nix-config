...
| `apps.md` | Hand-downloaded / App Store GUI apps; inventory generated by `macos-apps` | ⚠️ checklist, not auto-restore |
...
macos-apps   # rewrites the inventory in apps.md (bin/macos-apps, on PATH)
```

## When to consider nix-darwin

Today you have 5 brew formulae and 1 cask — a Brewfile is the right,
